...
# 2. Aplicação do Mecanismo de Laplace
epsilons = [0.1, np.log(2), np.log(4), 1.0]
epsilon_labels = ['0.1', 'ln(2)', 'ln(4)', '1.0']
num_consultas = len(contagem_real)
sensibilidade_global = 1

# 3. Criação do Gráfico com Matplotlib
